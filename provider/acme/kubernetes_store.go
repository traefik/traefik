...
// KubernetesStore Store implementation for kubernetes storage
...
// NewKubernetesStore initializes a new NewKubernetesStore with object prefix and namespace
func NewKubernetesStore(objectPrefix string, namespace string) KubernetesStore {
	store := KubernetesStore{ojbectPrefix: objectPrefix, namespace: namespace, SaveDataChan: make(chan *StoredData)}
