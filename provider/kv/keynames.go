...
const (
	...
	pathFrontendPassSSLClientCert                         = "/passSSLClientCert"
	pathFrontendPassSSLClientCertPem                      = pathFrontendPassSSLClientCert + "/pem"
	pathFrontendPassSSLClientCertInfos                    = pathFrontendPassSSLClientCert + "/infos"
	pathFrontendPassSSLClientCertInfosNotAfter            = pathFrontendPassSSLClientCertInfos + "/notAfter"
	pathFrontendPassSSLClientCertInfosNotBefore           = pathFrontendPassSSLClientCertInfos + "/notBefore"
	pathFrontendPassSSLClientCertInfosSans                = pathFrontendPassSSLClientCertInfos + "/sans"
	pathFrontendPassSSLClientCertInfosSubject             = pathFrontendPassSSLClientCertInfos + "/subject"
	pathFrontendPassSSLClientCertInfosSubjectCommonName   = pathFrontendPassSSLClientCertInfosSubject + "/commonName"
	pathFrontendPassSSLClientCertInfosSubjectCountry      = pathFrontendPassSSLClientCertInfosSubject + "/country"
	pathFrontendPassSSLClientCertInfosSubjectLocality     = pathFrontendPassSSLClientCertInfosSubject + "/locality"
	pathFrontendPassSSLClientCertInfosSubjectOrganization = pathFrontendPassSSLClientCertInfosSubject + "/organization"
	pathFrontendPassSSLClientCertInfosSubjectProvince     = pathFrontendPassSSLClientCertInfosSubject + "/province"
	pathFrontendPassSSLClientCertInfosSubjectSerialNumber = pathFrontendPassSSLClientCertInfosSubject + "/serialNumber"
