...
func TestDecodeConfiguration(t *testing.T) {
	labels := map[string]string{
		...
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.commonname":       "true",
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.country":          "true",
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.domaincomponent":  "true",
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.locality":         "true",
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.organization":     "true",
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.province":         "true",
		"traefik.middlewares.Middleware11.passtlsclientcert.info.issuer.serialnumber":     "true",
