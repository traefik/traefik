...
// WidgetTypesClient is the the Azure Customer Insights management API provides
...
// NewWidgetTypesClientWithBaseURI creates an instance of the WidgetTypesClient
// client.
...
// the hub. widgetTypeName is the name of the widget type.
