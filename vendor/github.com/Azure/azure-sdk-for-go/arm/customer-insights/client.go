// Package customerinsights implements the Azure ARM Customerinsights service
...
// resources. The API has entities that capture the relationship between an end
// user and the Azure Customer Insights service.
...
const (
	// APIVersion is the version of the Customerinsights
