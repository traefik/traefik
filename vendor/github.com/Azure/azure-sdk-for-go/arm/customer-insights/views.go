...
// ViewsClient is the the Azure Customer Insights management API provides a
...
// the hub. viewName is the name of the view. parameters is parameters supplied
// to the CreateOrUpdate View operation.
...
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the hub. viewName is the name of the view. userID is the user ID. Use * to
// retreive hub level view.
...
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the hub. userID is the user ID. Use * to retreive hub level views.
