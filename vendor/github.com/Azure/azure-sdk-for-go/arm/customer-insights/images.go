...
// ImagesClient is the the Azure Customer Insights management API provides a
...
// the hub. parameters is parameters supplied to the GetUploadUrlForData
// operation.
...
// GetUploadURLForEntityType gets entity type (profile or interaction) image
// upload URL.
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the hub. parameters is parameters supplied to the GetUploadUrlForEntityType
// operation.
