...
// KpiClient is the the Azure Customer Insights management API provides a
...
// CreateOrUpdate creates a KPI or updates an existing KPI in the hub. This
...
// Delete deletes a KPI in the hub. This method may poll for completion.
