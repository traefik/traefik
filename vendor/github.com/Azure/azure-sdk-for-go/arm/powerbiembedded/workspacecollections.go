...
// properties. A Power BI Workspace Collection contains one or more workspaces,
// and can be used to provision keys that provide API access to those
// workspaces.
//
...
// ListByResourceGroup retrieves all existing Power BI workspace collections in
