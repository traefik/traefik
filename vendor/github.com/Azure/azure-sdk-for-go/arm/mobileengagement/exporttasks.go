...
// NewExportTasksClientWithBaseURI creates an instance of the ExportTasksClient
// client.
...
// CreateFeedbackTaskByCampaign creates a task to export push campaign data for
// a set of campaigns.
//
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name.
...
//
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name. skip is
// control paging of export tasks, start results at the given offset, defaults
// to 0 (1st page of data). top is control paging of export tasks, number of
