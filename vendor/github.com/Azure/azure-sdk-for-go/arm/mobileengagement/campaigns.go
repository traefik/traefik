...
// application collection. appName is application resource name. kind is
// campaign kind. id is campaign identifier.
...
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name. kind is
// campaign kind. parameters is parameters supplied to the Update Campaign
// operation.
...
//
// kind is campaign kind. id is campaign identifier. resourceGroupName is the
// name of the resource group. appCollection is application collection. appName
...
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name. kind is
// campaign kind. name is campaign name.
...
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name. kind is
// campaign kind. skip is control paging of campaigns, start results at the
// given offset, defaults to 0 (1st page of data). top is control paging of
// campaigns, number of campaigns to return with each call. It returns all
// campaigns by default. When specifying $top parameter, the response contains
// a `nextLink` property describing the path to get the next page if there are
// more results. filter is filter can be used to restrict the results to
...
// finished. Only the eq operator and the state property are supported. orderby
// is sort results by an expression which looks like `$orderby=id asc` (this
// example is actually the default behavior). The syntax is orderby={property}
// {direction} or just orderby={property}. The available sorting properties are
// id, name, state, activatedDate, and finishedDate. The available directions
// are asc (for ascending order) and desc (for descending order). When not
// specified the asc direction is used. Only one property at a time can be used
// for sorting. search is restrict results to campaigns matching the optional
...
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name. kind is
// campaign kind. id is campaign identifier. parameters is parameters supplied
...
// resourceGroupName is the name of the resource group. appCollection is
// application collection. appName is application resource name. kind is
// campaign kind. parameters is parameters supplied to the Test Campaign
// operation.
...
// native push).
//
// kind is campaign kind. id is campaign identifier. parameters is parameters
// supplied to the Update Campaign operation. resourceGroupName is the name of
// the resource group. appCollection is application collection. appName is
