...
//
// groupObjectID is the object ID of the group to which to add the member.
// parameters is the URL of the member object, such as
...
// GetMemberGroups gets a collection of object IDs of groups of which the
// specified group is a member.
//
// objectID is the object ID of the group for which to get group membership.
// parameters is group filtering parameters.
...
// IsMemberOf checks whether the specified user, group, contact, or service
...
//
// groupObjectID is the object ID of the group from which to remove the member.
// memberObjectID is member object id
