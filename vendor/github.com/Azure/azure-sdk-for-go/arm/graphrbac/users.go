...
//
// upnOrObjectID is the object ID or principal name of the user for which to
// get information.
...
// GetMemberGroups gets a collection that contains the object IDs of the groups
// of which the user is a member.
//
// objectID is the object ID of the user for which to get group membership.
// parameters is user filtering parameters.
...
//
// upnOrObjectID is the object ID or principal name of the user to update.
// parameters is parameters to update an existing user.
