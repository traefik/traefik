...
// insensitive. workspaceName is name of the Log Analytics Workspace that will
// contain the datasource dataSourceName is the name of the datasource
// resource. parameters is the parameters required to create or update a
// datasource.
...
//
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is name of the Log Analytics Workspace that
// contains the datasource. dataSourceName is name of the datasource.
...
// ListByWorkspace gets the first page of data source instances in a workspace
// with the link to the next page.
//
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is the workspace that contains the data sources.
// filter is the filter to apply on the operation. skiptoken is starting point
// of the collection of data source instances.
