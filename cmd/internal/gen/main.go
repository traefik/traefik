...
const rootPkg = "github.com/baqupio/baqup/v3/pkg/config/dynamic"
...
func run(dest string) error {
	...
	centrifuge.ExcludedFiles = []string{
		"github.com/baqupio/baqup/v3/pkg/types/logs.go",
		"github.com/baqupio/baqup/v3/pkg/types/metrics.go",
	}
...
func cleanType(typ types.Type, base string) string {
	if typ.String() == "github.com/baqupio/baqup/v3/pkg/types.FileOrContent" {
		return "string"
	}
	...
	if strings.Contains(typ.String(), "github.com/baqupio/baqup/v3/pkg/") {
		return strings.ReplaceAll(typ.String(), "github.com/baqupio/baqup/v3/pkg/", "")
	}
...
func cleanPackage(src string) string {
	...
	case "github.com/traefik/paerser/types":
		return ""
	case "github.com/baqupio/baqup/v3/pkg/tls":
		return path.Join(destModuleName, destPkg, "tls")
	case "github.com/baqupio/baqup/v3/pkg/types":
