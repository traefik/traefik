...
- **test**: `make test`
- **test**: `make validate`
- **ci (inferred from workflow)**: `make binary`
- **ci (inferred from workflow)**: `make generate binary`
- **ci (inferred from workflow)**: `make multi-arch-image-experimental-${GITHUB_REF##*/}`
- **ci (inferred from workflow)**: `yarn tsc`
- **ci (inferred from workflow)**: `yarn lint`
- **ci (inferred from workflow)**: `yarn build`
- **ci (inferred from workflow)**: `make test-gateway-api-conformance`
- **ci (inferred from workflow)**: `make binary-linux-amd64`
