...
func (r *ProxyBuilder) Build(cfgName string, targetURL *url.URL, passHostHeader, keepPath bool) (http.Handler, error) {
	...
	return NewReverseProxy(targetURL, proxyURL, r.debug, passHostHeader, keepPath, responseHeaderTimeout, pool)
}
