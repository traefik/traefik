...
type AccessLog struct {
	...
	Force         bool              `description:"Forces Stdout or File access logging even if OTEL logging is enabled." json:"force,omitempty" toml:"force,omitempty" yaml:"force,omitempty" export:"true"`
