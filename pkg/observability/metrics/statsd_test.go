...
func testRegistry(t *testing.T, metricsPrefix string, registry Registry) {
	...
	udp.ShouldReceiveAll(t, expected, func() {
		...
		registry.EntryPointReqsCounter().With(nil, nil, "entrypoint", "test", "code", strconv.Itoa(http.StatusOK), "method", http.MethodGet).Add(1)
		...
		registry.RouterReqsCounter().With(nil, nil, "router", "demo", "service", "test", "code", strconv.Itoa(http.StatusNotFound), "method", http.MethodGet).Add(1)
		registry.RouterReqsCounter().With(nil, nil, "router", "demo", "service", "test", "code", strconv.Itoa(http.StatusOK), "method", http.MethodGet).Add(1)
		...
		registry.ServiceReqsCounter().With(nil, nil, "service", "test", "code", strconv.Itoa(http.StatusOK), "method", http.MethodGet).Add(1)
		registry.ServiceReqsCounter().With(nil, nil, "service", "test", "code", strconv.Itoa(http.StatusNotFound), "method", http.MethodGet).Add(1)
