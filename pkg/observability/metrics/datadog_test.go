...
func testDatadogRegistry(t *testing.T, metricsPrefix string, datadogRegistry Registry) {
	...
	udp.ShouldReceiveAll(t, expected, func() {
		...
		datadogRegistry.EntryPointReqsCounter().With(nil, nil, "entrypoint", "test").Add(1)
		...
		datadogRegistry.RouterReqsCounter().With(nil, nil, "router", "demo", "service", "test", "code", strconv.Itoa(http.StatusOK), "method", http.MethodGet).Add(1)
		datadogRegistry.RouterReqsCounter().With(nil, nil, "router", "demo", "service", "test", "code", strconv.Itoa(http.StatusNotFound), "method", http.MethodGet).Add(1)
		...
		datadogRegistry.ServiceReqsCounter().With(nil, nil, "service", "test", "code", strconv.Itoa(http.StatusOK), "method", http.MethodGet).Add(1)
		datadogRegistry.ServiceReqsCounter().With(nil, nil, "service", "test", "code", strconv.Itoa(http.StatusNotFound), "method", http.MethodGet).Add(1)
