...
type Shared struct {
	...
	RouterLabels       map[string]string `description:"Identity labels of this provider instance, used to evaluate per-router constraint expressions defined via 'traefik.<protocol>.routers.<name>.constraint' service labels." json:"routerLabels,omitempty" toml:"routerLabels,omitempty" yaml:"routerLabels,omitempty" export:"true"`
