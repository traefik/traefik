...
type Provider struct {
	...
	AllowEmptyServices      bool             `description:"Disregards the docker containers health checks regarding the creation or removal of the corresponding services." json:"allowEmptyServices,omitempty" toml:"allowEmptyServices,omitempty" yaml:"allowEmptyServices,omitempty" export:"true"`
