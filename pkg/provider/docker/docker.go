...
type Provider struct {
	...
	AllowEmptyServices      bool             `description:"Allow the creation of services without healthy containers." json:"allowEmptyServices,omitempty" toml:"allowEmptyServices,omitempty" yaml:"allowEmptyServices,omitempty" export:"true"`
