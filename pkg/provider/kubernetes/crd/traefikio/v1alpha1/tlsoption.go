...
// More info: https://doc.traefik.io/traefik/v3.5/reference/dynamic-configuration/https/tls/#tls-options
...
type TLSOptionSpec struct {
	...
	// More info: https://doc.traefik.io/traefik/v3.5/reference/dynamic-configuration/https/tls/#cipher-suites
	CipherSuites []string `json:"cipherSuites,omitempty"`
	// CurvePreferences defines the preferred elliptic curves.
	// More info: https://doc.traefik.io/traefik/v3.5/reference/dynamic-configuration/https/tls/#curve-preferences
	...
	// More info: https://doc.traefik.io/traefik/v3.5/reference/dynamic-configuration/https/tls/#alpn-protocols
