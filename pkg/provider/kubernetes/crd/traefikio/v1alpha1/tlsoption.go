...
type TLSOptionSpec struct {
	...
	// DisableSessionTickets when set to true, disables TLS session resumption via session tickets.
	DisableSessionTickets bool `json:"sessionTicketsDisabled,omitempty"`
