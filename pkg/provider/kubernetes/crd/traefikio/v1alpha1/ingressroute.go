...
type LoadBalancerSpec struct {
	...
	// Supported values are: wrr (Weighed round-robin), p2c (Power of two choices) and ewma (Exponentially weighted moving average).
	// RoundRobin value is deprecated and supported for backward compatibility.
	// TODO: when the deprecated RoundRobin value will be removed, set the default value to wrr.
	// +kubebuilder:validation:Enum=wrr;p2c;ewma;RoundRobin
