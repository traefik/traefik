...
type LoadBalancerSpec struct {
	...
	// Supported values are: wrr (Weighed round-robin), p2c (Power of two choices),
	// hrw (Highest Random Weight), leasttime (Least-Time) and ewma (Exponentially weighted moving average).
	// RoundRobin value is deprecated and supported for backward compatibility.
	// TODO: when the deprecated RoundRobin value will be removed, set the default kubebuilder value to wrr.
	// +kubebuilder:validation:Enum=wrr;p2c;hrw;leasttime;ewma;RoundRobin
