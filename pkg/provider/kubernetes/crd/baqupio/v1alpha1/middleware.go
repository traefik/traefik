...
// Middleware is the CRD implementation of a Baqup Middleware.
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/overview/
...
type MiddlewareSpec struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/overview/#community-middlewares
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/errorpages/
type ErrorPage struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/errorpages/#service
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/chain/
type Chain struct {
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/basicauth/
type BasicAuth struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/basicauth/#headerfield
...
// This middleware restricts access to your services to known users.
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/digestauth/
type DigestAuth struct {
	...
	Realm string `json:"realm,omitempty"`
	// HeaderField defines a header field to store the authenticated user.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/digestauth/#headerfield
	HeaderField string `json:"headerField,omitempty"`
}
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/forwardauth/
type ForwardAuth struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/forwardauth/#authresponseheadersregex
	...
	// HeaderField defines a header field to store the authenticated user.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/forwardauth/#headerfield
	HeaderField string `json:"headerField,omitempty"`
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/ratelimit/
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/compress/
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/middlewares/retry/
type Retry struct {
