...
type IngressRouteTCPSpec struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/routing/router/#tls
...
type RouteTCP struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/routing/rules-and-priority/
	Match string `json:"match"`
	// Priority defines the router's priority.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/routing/rules-and-priority/#priority
	// +kubebuilder:validation:Maximum=9223372036854774807
	Priority int `json:"priority,omitempty"`
	// Syntax defines the router's rule syntax.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/routing/rules-and-priority/#rulesyntax
...
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/tls/
type TLSTCP struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/tls/#tls-options
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/tls/#domains
...
type ServiceTCP struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/service/#proxy-protocol
...
// IngressRouteTCP is the CRD implementation of a Baqup TCP Router.
