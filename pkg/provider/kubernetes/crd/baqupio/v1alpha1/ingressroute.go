...
type IngressRouteSpec struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/install-configuration/entrypoints/
	// Default: all.
	EntryPoints []string `json:"entryPoints,omitempty"`
	// TLS defines the TLS configuration.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/routing/router/#tls
	...
	// More info: https://doc.baqup.io/baqup/v3.6/routing/routers/#parentrefs
...
type Route struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/routing/rules-and-priority/
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/routing/rules-and-priority/#priority
	// +kubebuilder:validation:Maximum=9223372036854774807
	Priority int `json:"priority,omitempty"`
	// Syntax defines the router's rule syntax.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/routing/rules-and-priority/#rulesyntax
	// Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.
	Syntax string `json:"syntax,omitempty"`
	// Services defines the list of Service.
	// It can contain any combination of BaqupService and/or reference to a Kubernetes Service.
	Services []Service `json:"services,omitempty"`
	// Middlewares defines the list of references to Middleware resources.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/kubernetes/crd/http/middleware/
	Middlewares []MiddlewareRef `json:"middlewares,omitempty"`
	// Observability defines the observability configuration for a router.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/routing/observability/
	Observability *dynamic.RouterObservabilityConfig `json:"observability,omitempty"`
}

// TLS holds the TLS configuration.
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/tls/overview/
type TLS struct {
	// SecretName is the name of the referenced Kubernetes Secret to specify the certificate details.
	SecretName string `json:"secretName,omitempty"`
	// Options defines the reference to a TLSOption, that specifies the parameters of the TLS connection.
	// If not defined, the `default` TLSOption is used.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/tls/tls-options/
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/install-configuration/tls/certificate-resolvers/acme/
	CertResolver string `json:"certResolver,omitempty"`
	// Domains defines the list of domains that will be used to issue certificates.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/tls/tls-certificates/#domains
...
type TLSOptionRef struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/kubernetes/crd/http/tlsoption/
...
type TLSStoreRef struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/kubernetes/crd/http/tlsstore/
	Name string `json:"name"`
...
// or a BaqupService object (a load-balancer of Baqup services).
type LoadBalancerSpec struct {
	// Name defines the name of the referenced Kubernetes Service or BaqupService.
	// The differentiation between the two is specified in the Kind field.
	Name string `json:"name"`
	// Kind defines the kind of the Service.
	// +kubebuilder:validation:Enum=Service;BaqupService
	Kind string `json:"kind,omitempty"`
	// Namespace defines the namespace of the referenced Kubernetes Service or BaqupService.
	Namespace string `json:"namespace,omitempty"`
	// Sticky defines the sticky sessions configuration.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/http/load-balancing/service/#sticky-sessions
	...
	// ResponseForwarding defines how Baqup forwards the response from the upstream Kubernetes Service to the client.
	ResponseForwarding *ResponseForwarding `json:"responseForwarding,omitempty"`
	// ServersTransport defines the name of ServersTransport resource to use.
	// It allows to configure the transport between Baqup and your servers.
	// Can only be used on a Kubernetes Service.
	ServersTransport string `json:"serversTransport,omitempty"`
	// Weight defines the weight and should only be specified when Name references a BaqupService object
...
type ServerHealthCheck struct {
	...
	// Timeout defines the maximum duration Baqup will wait for a health check request before considering the server unhealthy.
	// Default: 5s
...
// IngressRoute is the CRD implementation of a Baqup HTTP Router.
