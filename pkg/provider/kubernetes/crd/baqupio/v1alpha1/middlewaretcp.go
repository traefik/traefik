...
// MiddlewareTCP is the CRD implementation of a Baqup TCP middleware.
// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/middlewares/overview/
...
type MiddlewareTCPSpec struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/middlewares/ipwhitelist/
	IPWhiteList *dynamic.TCPIPWhiteList `json:"ipWhiteList,omitempty"`
	// IPAllowList defines the IPAllowList middleware configuration.
	// This middleware accepts/refuses connections based on the client IP.
	// More info: https://doc.baqup.io/baqup/v3.6/reference/routing-configuration/tcp/middlewares/ipallowlist/
