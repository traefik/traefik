...
func (p *Provider) createLoadBalancerServerTCP(client Client, parentNamespace string, service traefikv1alpha1.ServiceTCP) (*dynamic.TCPService, error) {
	...
	if service.HealthCheck != nil {
		...
		if service.HealthCheck.Interval != nil {
			if err := tcpService.LoadBalancer.HealthCheck.Interval.Set(service.HealthCheck.Interval.String()); err != nil {
				return nil, err
			}
		}
		if service.HealthCheck.Timeout != nil {
			if err := tcpService.LoadBalancer.HealthCheck.Timeout.Set(service.HealthCheck.Timeout.String()); err != nil {
				return nil, err
			}
		}
		if service.HealthCheck.UnhealthyInterval == nil {
			...
			if err := unhealthyInterval.Set(service.HealthCheck.UnhealthyInterval.String()); err != nil {
				return nil, err
			}
