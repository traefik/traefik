...
func (p *Provider) makeMiddlewareTCPKeys(ctx context.Context, ingRouteTCPNamespace string, middlewares []v1.ObjectReference) ([]string, error) {
	var mds []string
...
func (p *Provider) createLoadBalancerServerTCP(client Client, parentNamespace string, service v1.ServiceTCP) (*dynamic.TCPService, error) {
	ns := parentNamespace
...
func (p *Provider) loadTCPServers(client Client, namespace string, svc v1.ServiceTCP) ([]dynamic.TCPServer, error) {
...
func getTLSTCP(ctx context.Context, ingressRoute *v1.IngressRouteTCP, k8sClient Client, tlsConfigs map[string]*tls.CertAndStores) error {
