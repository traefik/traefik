...
func TestLoadIngressRoutes(t *testing.T) {
	testCases := []struct {
		...
		{
			desc:  "with loop, and leaf",
			paths: []string{"with_loop2.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop, and leaf in lower level",
			paths: []string{"with_loop3.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop in mirroring mains",
			paths: []string{"with_loop4.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop in mirroring children",
			paths: []string{"with_loop5.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop, deeper",
			paths: []string{"with_loop6.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop, mirror then weighted",
			paths: []string{"with_loop7.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop, do not break sibling branches",
			paths: []string{"with_loop8.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
		...
		{
			desc:  "with loop, do not break sibling branches, inverted order",
			paths: []string{"with_loop9.yml"},
			expected: &dynamic.Configuration{
				TLS: &dynamic.TLSConfiguration{},
				TCP: &dynamic.TCPConfiguration{
					Routers:  map[string]*dynamic.TCPRouter{},
