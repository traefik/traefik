...
type IngressRouteSpec struct {
	...
	// More info: https://doc.traefik.io/traefik/routing/routers/#tls
...
type Route struct {
	...
	// More info: https://doc.traefik.io/traefik/routing/routers/#priority
	Priority int `json:"priority,omitempty"`
	// Services defines the list of Service.
	// It can contain any combination of TraefikService and/or reference to a Kubernetes Service.
	Services []Service `json:"services,omitempty"`
	// Middlewares defines the list of references to Middleware resources.
	// More info: https://doc.traefik.io/traefik/routing/providers/kubernetes-crd/#kind-middleware
...
type TLSOptionRef struct {
	...
	// More info: https://doc.traefik.io/traefik/routing/providers/kubernetes-crd/#kind-tlsoption
...
type TLSStoreRef struct {
	...
	// More info: https://doc.traefik.io/traefik/routing/providers/kubernetes-crd/#kind-tlsstore
	Name string `json:"name"`
