...
type TLSOptionSpec struct {
	...
	// More info: https://doc.traefik.io/traefik/https/tls/#cipher-suites
	CipherSuites []string `json:"cipherSuites,omitempty"`
	// CurvePreferences defines the preferred elliptic curves in a specific order.
	// More info: https://doc.traefik.io/traefik/https/tls/#curve-preferences
	...
	// More info: https://doc.traefik.io/traefik/https/tls/#alpn-protocols
