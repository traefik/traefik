...
func (p *Provider) createLoadBalancerServerUDP(client Client, parentNamespace string, service baqupv1alpha1.ServiceUDP) (*dynamic.UDPService, error) {
	ns := parentNamespace
...
func (p *Provider) loadUDPServers(client Client, namespace string, svc baqupv1alpha1.ServiceUDP) ([]dynamic.UDPServer, error) {
