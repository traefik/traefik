...
func (p *Provider) createLoadBalancerServerUDP(client Client, parentNamespace string, service traefikv1.ServiceUDP) (*dynamic.UDPService, error) {
	ns := parentNamespace
...
func (p *Provider) loadUDPServers(client Client, namespace string, svc traefikv1.ServiceUDP) ([]dynamic.UDPServer, error) {
