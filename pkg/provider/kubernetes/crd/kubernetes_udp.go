...
func (p *Provider) createLoadBalancerServerUDP(client Client, parentNamespace string, service v1.ServiceUDP) (*dynamic.UDPService, error) {
	ns := parentNamespace
...
func (p *Provider) loadUDPServers(client Client, namespace string, svc v1.ServiceUDP) ([]dynamic.UDPServer, error) {
