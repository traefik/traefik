				...
				HTTP: &dynamic.HTTPConfiguration{
					Routers: map[string]*dynamic.Router{
						"default-ingress-with-permanent-redirect-rule-0-path-0": {
							...
							Middlewares: []string{"default-ingress-with-permanent-redirect-rule-0-path-0-permanent-redirect"},
						},
					},
					Middlewares: map[string]*dynamic.Middleware{
						"default-ingress-with-permanent-redirect-rule-0-path-0-permanent-redirect": {
