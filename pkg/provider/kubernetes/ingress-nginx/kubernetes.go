...
type Provider struct {
	...
	GlobalAuthURL    string              `description:"URL of the global auth server. It is used to configure the auth-url annotation for the global auth middleware." json:"globalAuthURL,omitempty" toml:"globalAuthURL,omitempty" yaml:"globalAuthURL,omitempty" export:"true"`
