	...
	testCases := []struct {
		...
		},
		{
			...
			expected: &dynamic.Configuration{
				...
				HTTP: &dynamic.HTTPConfiguration{
					Routers: map[string]*dynamic.Router{
						"default-http-app-1-my-gateway-web-74471866db6e94e08d00": {
							EntryPoints: []string{"web"},
							Service:     "default-http-app-1-my-gateway-web-74471866db6e94e08d00-wrr",
							Rule:        "Host(`foo.com`) && PathPrefix(`/`)",
							Middlewares: []string{"default-http-app-1-my-gateway-requestredirect"},
						},
					},
					Middlewares: map[string]*dynamic.Middleware{
						"default-http-app-1-my-gateway-requestredirect": {
					...
					Services: map[string]*dynamic.Service{
						"default-http-app-1-my-gateway-web-74471866db6e94e08d00-wrr": {
							Weighted: &dynamic.WeightedRoundRobin{
								Services: []dynamic.WRRService{
									{
										Name:   "default-whoami-80",
		...
		{
			desc:  "Simple HTTPRoute, HTTP header filters",
			paths: []string{"services.yml", "httproute/filter_http_headers.yml"},
			entryPoints: map[string]Entrypoint{"web": {
				Address: ":80",
			}},
			expected: &dynamic.Configuration{
				...
				HTTP: &dynamic.HTTPConfiguration{
					Routers: map[string]*dynamic.Router{
						"default-http-app-1-my-gateway-web-74471866db6e94e08d00": {
							...
							Service:     "default-http-app-1-my-gateway-web-74471866db6e94e08d00-wrr",
							Rule:        "Host(`foo.com`) && PathPrefix(`/`)",
							Middlewares: []string{"default-http-app-1-my-gateway-requestheadermodifier"},
						},
					},
					Middlewares: map[string]*dynamic.Middleware{
						"default-http-app-1-my-gateway-requestheadermodifier": {
							Headers: &dynamic.Headers{
								CustomRequestHeaders: map[string]string{
									"X-My-Header":       "foo",
									"X-My-Other-Header": "bar",
									"X-Another-Header":  "",
								},
							},
						},
