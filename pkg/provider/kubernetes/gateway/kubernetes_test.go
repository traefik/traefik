...
func TestLoadHTTPRoutes(t *testing.T) {
	testCases := []struct {
		...
		{
			desc:  "HTTPRoute with SessionPersistence",
			paths: []string{"services.yml", "httproute/with_session_persistence.yml"},
			entryPoints: map[string]Entrypoint{"web": {
				Address: ":80",
			}},
			expected: &dynamic.Configuration{
				...
				HTTP: &dynamic.HTTPConfiguration{
					Routers: map[string]*dynamic.Router{
						"httproute-default-http-app-sticky-gw-default-my-gateway-ep-web-0-1f905b31c04c531dd726": {
							EntryPoints: []string{"web"},
							Service:     "httproute-default-http-app-sticky-gw-default-my-gateway-ep-web-0-1f905b31c04c531dd726-wrr",
							Rule:        "Host(`foo.com`) && Path(`/sticky`)",
							Priority:    100008,
							RuleSyntax:  "default",
						},
					},
					Middlewares: map[string]*dynamic.Middleware{},
					Services: map[string]*dynamic.Service{
						"httproute-default-http-app-sticky-gw-default-my-gateway-ep-web-0-1f905b31c04c531dd726-wrr": {
							Weighted: &dynamic.WeightedRoundRobin{
								Services: []dynamic.WRRService{
									{
										Name:   "default-whoami-http-80-sticky-SERVERID-3600",
										Weight: ptr.To(1),
									},
								},
							},
						},
						"default-whoami-http-80-sticky-SERVERID-3600": {
							LoadBalancer: &dynamic.ServersLoadBalancer{
								Strategy: dynamic.BalancerStrategyWRR,
