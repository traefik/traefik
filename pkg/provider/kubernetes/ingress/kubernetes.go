...
type Provider struct {
	...
	IngressClassController string           `description:"Value for controller attribute of IngressClass to watch for." json:"IngressClassController,omitempty" toml:"IngressClassController,omitempty" yaml:"IngressClassController,omitempty" export:"true"`
