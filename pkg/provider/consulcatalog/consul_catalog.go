...
type Provider struct {
	...
	RefreshInterval   ptypes.Duration `description:"Interval for check Consul API. Default 15sec" json:"refreshInterval,omitempty" toml:"refreshInterval,omitempty" yaml:"refreshInterval,omitempty" export:"true"`
