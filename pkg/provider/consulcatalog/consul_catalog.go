...
type Configuration struct {
	...
	StrictChecks      []string        `description:"A list of service health statuses to allow taking traffic. Defaults to [\"passing\", \"warning\"]." json:"strictChecks,omitempty" toml:"strictChecks,omitempty" yaml:"strictChecks,omitempty" export:"true"`
}
