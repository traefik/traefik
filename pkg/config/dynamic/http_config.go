...
const (
	...
	// DefaultHealtCheckRecheck is the default value for the ServerHealthCheck recheck.
	DefaultHealtCheckRecheck = ptypes.Duration(10 * time.Second)
...
func (h *ServerHealthCheck) SetDefaults() {
	...
	h.Recheck = DefaultHealtCheckRecheck
}
