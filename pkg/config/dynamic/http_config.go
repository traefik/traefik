...
type Mirroring struct {
	...
	// TODO(mpl): doc. and web doc.
	// TODO(mpl): actually since mirroring is completely transparent in that respect, we could chose to not even have any healtheck configuration here.
