...
type ServersTransport struct {
	...
	DisableCompression  bool                    `description:"Disables automatic request compression. When true, Traefik does not add Accept-Encoding: gzip to requests and does not decompress responses." json:"disableCompression,omitempty" toml:"disableCompression,omitempty" yaml:"disableCompression,omitempty" export:"true"`
