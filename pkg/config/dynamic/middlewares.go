...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/addprefix/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/basicauth/
type BasicAuth struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/basicauth/#headerfield
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/buffering/#maxrequestbodybytes
type Buffering struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/buffering/#retryexpression
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/circuitbreaker/
...
// This middleware restricts access to your services to known users.
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/digestauth/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/forwardauth/
type ForwardAuth struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/forwardauth/#authresponseheadersregex
	...
	// HeaderField defines a header field to store the authenticated user.
	// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/forwardauth/#headerfield
	HeaderField string `json:"headerField,omitempty" toml:"headerField,omitempty" yaml:"headerField,omitempty" export:"true"`
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/headers/#customrequestheaders
type Headers struct {
...
// IPStrategy holds the IP strategy configuration used by Baqup to determine the client IP.
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/ipallowlist/#ipstrategy
type IPStrategy struct {
	// Depth tells Baqup to use the X-Forwarded-For header and take the IP located at the depth position (starting from the right).
	// +kubebuilder:validation:Minimum=0
	...
	// IPv6Subnet configures Baqup to consider all IPv6 addresses from the defined subnet as originating from the same IP. Applies to RemoteAddrStrategy and DepthStrategy.
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/ipwhitelist/
// Deprecated: please use IPAllowList instead.
...
// This middleware limits allowed requests based on the client IP.
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/ipallowlist/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/inflightreq/
type InFlightReq struct {
	...
	// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/inflightreq/#sourcecriterion
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/passtlsclientcert/
...
type RateLimit struct {
	...
	// If not specified, Baqup will default to an in-memory bucket for the algorithm.
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/redirectregex/#regex
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/redirectscheme/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/replacepath/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/replacepathregex/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/retry/
type Retry struct {
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/stripprefix/
...
// More info: https://doc.baqup.io/baqup/v3.6/middlewares/http/stripprefixregex/
