...
type Middleware struct {
	...
	FilterTLSClientCert *FilterTLSClientCert `json:"filterTLSClientCert,omitempty" toml:"filterTLSClientCert,omitempty" yaml:"filterTLSClientCert,omitempty" export:"true"`
...
// FilterTLSClientCert holds the filter TLS client cert middleware configuration.
// This middleware rejects requests whose client certificate Subject or Issuer DN does not match the configured regexes.
// +k8s:deepcopy-gen=true
type FilterTLSClientCert struct {
	// Subject is a regular expression matched against the full Subject DN of the client certificate.
	// If empty, the Subject is not checked.
	Subject string `json:"subject,omitempty" toml:"subject,omitempty" yaml:"subject,omitempty" export:"true"`
	// Issuer is a regular expression matched against the full Issuer DN of the client certificate.
