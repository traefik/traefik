...
func TestDecodeConfiguration(t *testing.T) {
	labels := map[string]string{
		...
		"traefik.tcp.services.Service0.loadbalancer.addrLookupCache":                   "10s",
		"traefik.tcp.services.Service1.loadbalancer.server.Port":                       "42",
		"traefik.tcp.services.Service1.loadbalancer.TerminationDelay":                  "42",
		"traefik.tcp.services.Service1.loadbalancer.addrLookupCache":                   "10s",
			...
			Services: map[string]*dynamic.TCPService{
				"Service0": {
					LoadBalancer: &dynamic.TCPServersLoadBalancer{
						...
						AddrLookupCache:  ptypes.Duration(10 * time.Second),
					},
				},
				"Service1": {
					LoadBalancer: &dynamic.TCPServersLoadBalancer{
...
func TestEncodeConfiguration(t *testing.T) {
	...
	expected := map[string]string{
		...
		"traefik.TCP.Services.Service0.LoadBalancer.server.Port":      "42",
		"traefik.TCP.Services.Service0.LoadBalancer.TerminationDelay": "42",
		"traefik.TCP.Services.Service0.LoadBalancer.AddrLookupCache":  "10000000000",
		"traefik.TCP.Services.Service1.LoadBalancer.server.Port":      "42",
		"traefik.TCP.Services.Service1.LoadBalancer.TerminationDelay": "42",
		"traefik.TCP.Services.Service1.LoadBalancer.AddrLookupCache":  "10000000000",
