...
func TestDecodeConfiguration(t *testing.T) {
	labels := map[string]string{
		...
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolallowcredentials":     "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.allowedhosts":                      "foobar, fiibar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolallowheaders":         "X-foobar, X-fiibar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolallowmethods":         "GET, PUT",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolalloworiginList":      "foobar, fiibar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolalloworiginListRegex": "foobar, fiibar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolexposeheaders":        "X-foobar, X-fiibar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.accesscontrolmaxage":               "200",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.addvaryheader":                     "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.browserxssfilter":                  "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.contentsecuritypolicy":             "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.contenttypenosniff":                "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.custombrowserxssvalue":             "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.customframeoptionsvalue":           "foobar",
		...
		"traefik.http.middlewares.Middleware8.headers.securityheaders.forcestsheader":                    "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.framedeny":                         "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.hostsproxyheaders":                 "foobar, fiibar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.isdevelopment":                     "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.publickey":                         "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.referrerpolicy":                    "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.permissionspolicy":                 "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.sslproxyheaders.name0":             "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.sslproxyheaders.name1":             "foobar",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.stsincludesubdomains":              "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.stspreload":                        "true",
		"traefik.http.middlewares.Middleware8.headers.securityheaders.stsseconds":                        "42",
