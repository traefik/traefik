...
func TestDecodeConfiguration(t *testing.T) {
	labels := map[string]string{
		...
		"traefik.http.services.Service0.loadbalancer.healthcheck.fails":                "42",
		"traefik.http.services.Service0.loadbalancer.healthcheck.passes":               "42",
		...
		"traefik.http.services.Service1.loadbalancer.healthcheck.fails":                "42",
		"traefik.http.services.Service1.loadbalancer.healthcheck.passes":               "42",
