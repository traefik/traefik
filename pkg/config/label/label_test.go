...
func TestDecodeConfiguration(t *testing.T) {
	labels := map[string]string{
		...
		"traefik.tcp.services.Service0.loadbalancer.ProxyProtocolVersion":              "1",
		"traefik.tcp.services.Service1.loadbalancer.server.Port":                       "42",
		"traefik.tcp.services.Service1.loadbalancer.TerminationDelay":                  "42",
		"traefik.tcp.services.Service1.loadbalancer.ProxyProtocolVersion":              "2",
			...
			Services: map[string]*dynamic.TCPService{
				"Service0": {
					LoadBalancer: &dynamic.TCPServersLoadBalancer{
						...
						ProxyProtocolVersion: func(i int) *int { return &i }(1),
					},
				},
				"Service1": {
					LoadBalancer: &dynamic.TCPServersLoadBalancer{
						...
						TerminationDelay:     func(i int) *int { return &i }(42),
						ProxyProtocolVersion: func(i int) *int { return &i }(2),
					},
				},
			},
		},
