...
type Tracing struct {
	...
	UnRedactedQueryParams   []string          `description:"Query params to un-redact." json:"unRedactedQueryParams,omitempty" toml:"unRedactedQueryParams,omitempty" yaml:"unRedactedQueryParams,omitempty" export:"true"`
