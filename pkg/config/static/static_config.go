...
type API struct {
	...
	DebugConnection    bool `description:"Enable additional expvar for debugging connections." json:"debugConnection,omitempty" toml:"debugConnection,omitempty" yaml:"debugConnection,omitempty" export:"true"`
