...
type Providers struct {
	...
	Knative                *knative.Provider              `description:"Enable Knative provider." json:"knative,omitempty" toml:"knative,omitempty" yaml:"knative,omitempty" label:"allowEmpty" file:"allowEmpty" export:"true"`
