...
type Tracing struct {
	...
	SpanNameFormat          string             `description:"Span name format, used for most tracing UIs." json:"spanNameFormat,omitempty" toml:"spanNameFormat,omitempty" yaml:"spanNameFormat,omitempty" label:"allowEmpty" file:"allowEmpty" export:"true"`
