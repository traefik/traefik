...
type API struct {
	...
	DisableDashboardDemo bool   `description:"Disable demo section in the dashboard." json:"disableDashboardDemo,omitempty" toml:"disableDashboardDemo,omitempty" yaml:"disableDashboardDemo,omitempty" export:"true"`
