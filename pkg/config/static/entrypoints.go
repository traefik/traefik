...
type EntryPoint struct {
	...
	ACMEByPass       bool                  `description:"Determines whether ACME TLS or HTTP challenge are allowed to be handle with custom routers." json:"ACMEByPass,omitempty" toml:"ACMEByPass,omitempty" yaml:"ACMEByPass,omitempty"`
