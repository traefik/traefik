...
type EntryPoint struct {
	...
	DefaultSet       bool                  `description:"Defines whether to add this EntryPoint to the default set." json:"defaultSet,omitempty" toml:"defaultSet,omitempty" yaml:"defaultSet,omitempty"`
