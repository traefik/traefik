...
type HTTPConfig struct {
	...
	DecodePathSlashes     bool `description:"Defines whether to decode slashes in the path (%2F, %2f, %5C, and %5c)." json:"decodePathSlashes,omitempty" toml:"decodePathSlashes,omitempty" yaml:"decodePathSlashes,omitempty" export:"true"`
