...
type EntryPoint struct {
	...
	AllowACMEByPass  bool                  `description:"Determines whether ACME TLS or HTTP challenge are allowed to be handle with custom routers." json:"allowACMEByPass,omitempty" toml:"allowACMEByPass,omitempty" yaml:"allowACMEByPass,omitempty"`
