...
type Experimental struct {
	...
	OTLPLogs             bool                               `description:"Enables the OpenTelemetry logs implementation." json:"otlplogs,omitempty" toml:"otlplogs,omitempty" yaml:"otlplogs,omitempty" label:"allowEmpty" file:"allowEmpty" export:"true"`
