...
// pluginProvider The static part of a plugin configuration.
...
func newProvider(descriptor pluginProvider, config map[string]interface{}, providerName string) (*Provider, error) {
