...
type AccessLog struct {
	...
	FileCacheSize int               `description:"Size of access log underlying buffer in bytes." json:"fileCacheSize,omitempty" toml:"fileCacheSize,omitempty" yaml:"fileCacheSize,omitempty" export:"true"`
}
