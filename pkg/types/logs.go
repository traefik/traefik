...
type AccessLog struct {
	...
	Format        string            `description:"Access log format: json | common | pattern" json:"format,omitempty" toml:"format,omitempty" yaml:"format,omitempty" export:"true"`
	Pattern       string            `description:"Access log custom format json:"pattern,omitempty" toml:"pattern,omitempty" yaml:"pattern,omitempty" export:"true"`
