...
func TestDatadog(t *testing.T) {
	...
	datadogRegistry := RegisterDatadog(context.Background(), &types.DataDog{Address: ":18125", PushInterval: types.Duration(time.Second), OnEntryPoints: true, OnServices: true})
	defer StopDatadog()
