...
func TestForwardAuthUsesTracing(t *testing.T) {
	...
	tr, _ := tracing.NewTracing("testApp", 100, &mockBackend{tracerProvider.Tracer("mock-tracer")})
...
func (b *mockBackend) Setup(componentName string) (trace.Tracer, io.Closer, error) {
