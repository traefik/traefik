...
// NeedsWrap returns whether the given http.ResponseWriter is the capture's probe.
func NeedsWrap(rw http.ResponseWriter, c Capture) bool {
	// TODO: Is it really what we want to compare?
	return c.rw != rw
}
