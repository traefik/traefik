...
import (
	...
	metricsMiddle "github.com/baqupio/baqup/v3/pkg/middlewares/metrics"
	...
	"github.com/baqupio/baqup/v3/pkg/server/cookie"
	"github.com/baqupio/baqup/v3/pkg/server/middleware"
	"github.com/baqupio/baqup/v3/pkg/server/provider"
	"github.com/baqupio/baqup/v3/pkg/server/service/loadbalancer/failover"
	"github.com/baqupio/baqup/v3/pkg/server/service/loadbalancer/hrw"
	"github.com/baqupio/baqup/v3/pkg/server/service/loadbalancer/leasttime"
	"github.com/baqupio/baqup/v3/pkg/server/service/loadbalancer/mirror"
	"github.com/baqupio/baqup/v3/pkg/server/service/loadbalancer/p2c"
	"github.com/baqupio/baqup/v3/pkg/server/service/loadbalancer/wrr"
