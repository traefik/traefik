...
func TestReuseService(t *testing.T) {
	...
	factory := NewRouterFactory(staticConfig, managerFactory, tlsManager, middleware.NewChainBuilder(staticConfig, metrics.NewVoidRegistry(), nil, nil, nil), nil, metrics.NewVoidRegistry())
...
func TestInternalServices(t *testing.T) {
	...
	factory := NewRouterFactory(staticConfig, managerFactory, tlsManager, middleware.NewChainBuilder(staticConfig, voidRegistry, nil, nil, nil), nil, voidRegistry)
