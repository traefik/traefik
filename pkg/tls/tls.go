...
type Options struct {
	...
	SessionTicketsDisabled bool       `json:"sessionTicketDisabled,omitempty" toml:"sessionTicketDisabled,omitempty" yaml:"sessionTicketDisabled,omitempty" export:"true"`
