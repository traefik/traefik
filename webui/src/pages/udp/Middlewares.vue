      ...
      <div class="app-section-wrap app-boxed app-boxed-xl q-pl-md q-pr-md q-pt-xl q-pb-xl">
        ...
        <div class="row items-center q-col-gutter-lg">
          <div class="col-12">
            <main-table
              ref="mainTable"
              v-bind="getTableProps({ type: 'udp-middlewares' })"
...
export default {
  ...
  computed: {
    ...mapGetters('udp', { allMiddlewares: 'allMiddlewares' })
  },
  methods: {
    ...mapActions('udp', { getAllMiddlewares: 'getAllMiddlewares' }),
  ...
  beforeDestroy () {
    this.$store.commit('udp/getAllMiddlewaresClear')
  }
}
</script>
