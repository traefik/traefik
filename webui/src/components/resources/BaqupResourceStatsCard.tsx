...
export type BaqupResourceStatsType = {
  title?: string
  errors: number
  total: number
  warnings: number
...
export type BaqupResourceStatsCardProps = BaqupResourceStatsType & {
  linkTo: string
}
...
const BaqupResourceStatsCard = ({ title, errors, total, warnings, linkTo }: BaqupResourceStatsCardProps) => {
...
export default BaqupResourceStatsCard
