...
Care should be taken when defining replacement variables; $1x is equivalent to ${1x}, not ${1}x [see Regexp.Expand](https://golang.org/pkg/regexp/#Regexp.Expand)

Regex expressions and replacements can be tested using the [Go Playground](https://play.golang.org/p/mWU9p-wk2ru)
