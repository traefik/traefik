...
| `traefik.ingress.kubernetes.io/cname-flattening: "true"`                        | Enable CNAME Flattening, default is false, see [host resolver](/configuration/commons/#host-resolver) section.                                                                                                                                                                                                                            |
