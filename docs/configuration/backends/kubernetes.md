...
| `ingress.kubernetes.io/hsts-max-age:315360000`                                     | Sets the max-age of the STS header.                                                                                                                                                                                                                                                                                                                                            |
| `ngress.kubernetes.io/hsts-include-subdomains:true`                                     | Adds the IncludeSubdomains section of the STS  header.                                                                                                                                                                                                                                                                                                                                            |
| `ingress.kubernetes.io/hsts-preload:true`                                     | Adds the preload flag to the STS  header.                                                                                                                                                                                                                                                                                                                                            |
