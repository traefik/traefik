...
| HTTP request                                           | `httpreq`      | `HTTPREQ_ENDPOINT`, `HTTPREQ_MODE`, `HTTPREQ_USERNAME`, `HTTPREQ_PASSWORD` (more info on the HTTP message format can be foound [here](https://github.com/xenolf/lego/blob/master/providers/dns/httpreq/readme.md))                                                                | YES                            |
