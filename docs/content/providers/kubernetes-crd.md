...
If you're in a hurry, maybe you'd rather go through the [static](../reference/static-configuration.md) and the [dynamic](../reference/providers/kubernetes-crd.md) configuration references.
