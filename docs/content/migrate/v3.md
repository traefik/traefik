...
### Change in `traefik_tls_certs_not_after` metric name

Starting with `v3.5.4` the `traefik_tls_certs_not_after_milliseconds` metric is renamed to `traefik_tls_certs_not_after_seconds`. As it was found that the unit of this metric was `second`.
