...
Starting with `v3.7.0`, the Kubernetes Gateway API provider supports version [v1.5.0](https://github.com/kubernetes-sigs/gateway-api/releases/tag/v1.5.0) of the specification,
which requires the Gateway API CRDs to be updated.
