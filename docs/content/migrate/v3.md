...
- [TraefikService](../reference/routing-configuration/http/load-balancing/service.md#mirroring-service) ([PR #11032](https://github.com/traefik/traefik/pull/11032))
- [RateLimit](../reference/routing-configuration/http/middlewares/ratelimit.md) & [InFlightReq](../reference/routing-configuration/http/middlewares/inflightreq.md) middlewares ([PR #9747](https://github.com/traefik/traefik/pull/9747))
- [Compress](../reference/routing-configuration/http/middlewares/compress.md) middleware ([PR #10943](https://github.com/traefik/traefik/pull/10943))
...
Refer to the [HTTP Services Load Balancing documentation](../reference/routing-configuration/http/load-balancing/service.md#load-balancing-strategy) for detailed information.
