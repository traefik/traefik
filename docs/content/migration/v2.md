...
In `v2.3`, we support the newly introduced `IngressClass` available since Kubernetes version `1.18`.
In order to be able to use this resource you have to update the [Kubernetes RBAC](../reference/dynamic-configuration/kubernetes-crd.md#rbac). 
