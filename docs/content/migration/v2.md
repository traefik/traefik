...
In addition, the Kubernetes CRDs API Version "traefik.io/v1alpha1" will not be supported in Traefik v3 itself. However, an automatic migration path to the next version will be available.
