...
For the metrics, HTTP Methods not defined in [common](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods),
[revised](https://datatracker.ietf.org/doc/html/rfc5789#section-2),
or [HTTP/2](https://datatracker.ietf.org/doc/html/rfc7540#section-11.6) method definition are stored in the `EXTENSION_METHOD` bucket.
