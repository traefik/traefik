...
Starting with v3.2, the CRDs has been updated on [TraefikService](../routing/services#mirroring-service) (PR [#11032](https://github.com/traefik/traefik/pull/11032)) and on `RateLimit` and `InFlightReq` middlewares (PR [#9747](https://github.com/traefik/traefik/pull/9747)).
