...
It also brings NodePort load-balancing which need Nodes resources lookup.
...
### Ingress Class Lookup

The Kubernetes Ingress provider `disableIngressClassLookup` option has been deprecated in v3.1.1, and will be removed in the next major version.
