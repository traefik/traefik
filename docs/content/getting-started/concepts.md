---
title: Concepts
description: Baqup - base concepts and main features
---

# Concepts

This page explains the base concepts of Baqup.

---

## Introduction

Baqup is based on the concept of EntryPoints, Routers, Middlewares and Services.
...
1. [EntryPoints](../routing/entrypoints.md "Link to docs about EntryPoints"): EntryPoints are the network entry points into Baqup. They define the port which will receive the packets, and whether to listen for TCP or UDP.
...
Baqup is an *Edge Router*; this means that it's the door to your platform, and that it intercepts and routes every incoming request:
...
![The Door to Your Infrastructure](../assets/img/baqup-concepts-1.png "Picture explaining the infrastructure")

## Auto Service Discovery

Where traditionally edge routers (or reverse proxies) need a configuration file that contains every possible route to your services, Baqup gets them from the services themselves.

Deploying your services, you attach information that tells Baqup the characteristics of the requests the services can handle.

![Decentralized Configuration](../assets/img/baqup-concepts-2.png "Picture about Decentralized Configuration")

This means that when a service is deployed, Baqup detects it immediately and updates the routing rules in real time.
...
!!! question "How does Baqup discover the services?"

    Baqup is able to use your cluster API to discover the services and read the attached information.
    In Baqup, these connectors are called [providers](../providers/overview.md "Link to overview about Baqup providers") because they *provide* the configuration to Baqup.
