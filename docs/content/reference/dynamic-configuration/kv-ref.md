...
| `traefik/http/serversTransports/ServersTransport0/certificates/0/ocsp/disableStapling` | `true` |
| `traefik/http/serversTransports/ServersTransport0/certificates/0/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/http/serversTransports/ServersTransport0/certificates/0/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/http/serversTransports/ServersTransport0/certificates/1/ocsp/disableStapling` | `true` |
| `traefik/http/serversTransports/ServersTransport0/certificates/1/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/http/serversTransports/ServersTransport0/certificates/1/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/http/serversTransports/ServersTransport1/certificates/0/ocsp/disableStapling` | `true` |
| `traefik/http/serversTransports/ServersTransport1/certificates/0/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/http/serversTransports/ServersTransport1/certificates/0/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/http/serversTransports/ServersTransport1/certificates/1/ocsp/disableStapling` | `true` |
| `traefik/http/serversTransports/ServersTransport1/certificates/1/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/http/serversTransports/ServersTransport1/certificates/1/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tcp/serversTransports/TCPServersTransport0/tls/certificates/0/ocsp/disableStapling` | `true` |
| `traefik/tcp/serversTransports/TCPServersTransport0/tls/certificates/0/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tcp/serversTransports/TCPServersTransport0/tls/certificates/0/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tcp/serversTransports/TCPServersTransport0/tls/certificates/1/ocsp/disableStapling` | `true` |
| `traefik/tcp/serversTransports/TCPServersTransport0/tls/certificates/1/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tcp/serversTransports/TCPServersTransport0/tls/certificates/1/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tcp/serversTransports/TCPServersTransport1/tls/certificates/0/ocsp/disableStapling` | `true` |
| `traefik/tcp/serversTransports/TCPServersTransport1/tls/certificates/0/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tcp/serversTransports/TCPServersTransport1/tls/certificates/0/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tcp/serversTransports/TCPServersTransport1/tls/certificates/1/ocsp/disableStapling` | `true` |
| `traefik/tcp/serversTransports/TCPServersTransport1/tls/certificates/1/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tcp/serversTransports/TCPServersTransport1/tls/certificates/1/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tls/certificates/0/ocsp/disableStapling` | `true` |
| `traefik/tls/certificates/0/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tls/certificates/0/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tls/certificates/1/ocsp/disableStapling` | `true` |
| `traefik/tls/certificates/1/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tls/certificates/1/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tls/stores/Store0/defaultCertificate/ocsp/disableStapling` | `true` |
| `traefik/tls/stores/Store0/defaultCertificate/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tls/stores/Store0/defaultCertificate/ocsp/responderOverrides/name1` | `foobar` |
...
| `traefik/tls/stores/Store1/defaultCertificate/ocsp/disableStapling` | `true` |
| `traefik/tls/stores/Store1/defaultCertificate/ocsp/responderOverrides/name0` | `foobar` |
| `traefik/tls/stores/Store1/defaultCertificate/ocsp/responderOverrides/name1` | `foobar` |
