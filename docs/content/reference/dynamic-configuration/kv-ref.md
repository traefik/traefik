...
| `traefik/http/middlewares/Middleware04/circuitBreaker/checkPeriod` | `foobar` |
| `traefik/http/middlewares/Middleware04/circuitBreaker/expression` | `foobar` |
| `traefik/http/middlewares/Middleware04/circuitBreaker/fallbackDuration` | `foobar` |
| `traefik/http/middlewares/Middleware04/circuitBreaker/recoveryDuration` | `foobar` |
