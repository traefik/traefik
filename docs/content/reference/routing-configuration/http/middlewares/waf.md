...
description: 'Baqup Hub API Gateway - The HTTP Coraza in Baqup Hub API Gateway provides web application firewall capabilities'
---
...
The [Coraza WAF](https://coraza.io/) middleware in Baqup Hub API Gateway provides web application firewall capabilities.

The native middleware in Hub API Gateway provides at least 23 times more performance compared to the
WASM-based [Coraza plugin](https://plugins.baqup.io/plugins/65f2aea146079255c9ffd1ec/coraza-waf) available with the open-source Baqup Proxy.
...
!!! warning
    ...
    Starting with Baqup Hub v3.11.0, Coraza needs to have read/write permissions to `/tmp`. This is related to [this upstream PR](https://github.com/corazawaf/coraza/pull/1030).
