...
| <a id="opt-tls-peerCertSubjectAltNames" href="#opt-tls-peerCertSubjectAltNames" title="#opt-tls-peerCertSubjectAltNames">`tls.peerCertSubjectAltNames`</a> | Defines the SANs (Subject Alternative Names) used to match against SANs during the peer certificate verification.                                                                                                                                                                                                                                                                                               | []      | No       |
| <a id="opt-tls-peerCertSubjectAltNames-type" href="#opt-tls-peerCertSubjectAltNames-type" title="#opt-tls-peerCertSubjectAltNames-type">`tls.peerCertSubjectAltNames[].type`</a> | Defines the SAN type (`URI` or `DNSName`) to match against the peer certificate's Subject Alternative Names.                                                                    | ""      | No       |
| <a id="opt-tls-peerCertSubjectAltNames-value" href="#opt-tls-peerCertSubjectAltNames-value" title="#opt-tls-peerCertSubjectAltNames-value">`tls.peerCertSubjectAltNames[].value`</a> | Defines the SAN value to match against the peer certificate's Subject Alternative Names.                  | ""      | No       |
