...
| <a id="opt-routesn-respondingTimeouts-roundTrip" href="#opt-routesn-respondingTimeouts-roundTrip" title="#opt-routesn-respondingTimeouts-roundTrip">`routes[n].`<br />`respondingTimeouts.`<br />`roundTrip`</a> | Defines the maximum duration for the whole client transaction on the route.<br />`0` (or unset) means no timeout. See [responding timeouts](../../../http/routing/router.md#responding-timeouts) for more information.                                                                                                                                                           | 0       | No       |
