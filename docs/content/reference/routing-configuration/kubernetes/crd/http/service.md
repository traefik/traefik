...
| <a id="opt-middlewares" href="#opt-middlewares" title="#opt-middlewares">`middlewares`</a> | List of middlewares to apply to this service child.<br />Supported on service references inside an `IngressRoute` route and on children inside a `TraefikService` `weighted`, `highestRandomWeight`, `mirroring` (main service + mirrors), and `failover` (service + fallback) blocks (for both `Service` and `TraefikService` kinds).                                                                                                                                                                                                                                                                                                                                                                                   |                                                                      | No       |
| <a id="opt-middlewaresm-name" href="#opt-middlewaresm-name" title="#opt-middlewaresm-name">`middlewares[m].`<br />`name`</a> | Middleware name.<br />The character `@` is not authorized.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                      | Yes      |
| <a id="opt-middlewaresm-namespace" href="#opt-middlewaresm-namespace" title="#opt-middlewaresm-namespace">`middlewares[m].`<br />`namespace`</a> | Middleware namespace.<br />Can be empty if the middleware belongs to the same namespace as the parent resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | ""                                                                   | No       |
