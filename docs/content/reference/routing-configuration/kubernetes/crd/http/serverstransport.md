...
| <a id="opt-serverstransport-disableCompression" href="#opt-serverstransport-disableCompression" title="#opt-serverstransport-disableCompression">`serverstransport.`<br />`disableCompression`</a> | Disables compression handling for connections with servers. | false | No |
...
| <a id="opt-serverstransport-disableCompression-2" href="#opt-serverstransport-disableCompression-2" title="#opt-serverstransport-disableCompression-2">`serverstransport.`<br />`disableCompression`</a> | Disables compression handling for connections with servers. | false | No |
