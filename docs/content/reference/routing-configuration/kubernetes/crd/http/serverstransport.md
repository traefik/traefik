...
| <a id="opt-serverstransport-rootcasSecrets" href="#opt-serverstransport-rootcasSecrets" title="#opt-serverstransport-rootcasSecrets">`serverstransport.`<br />`rootcasSecrets`</a> | Set of root certificate authorities to use when verifying server certificates. (for mTLS connections). |  | No |
