...
| <a id="opt-serverstransport-preferIPv6" href="#opt-serverstransport-preferIPv6" title="#opt-serverstransport-preferIPv6">`serverstransport.`<br />`preferIPv6`</a> | Prefers IPv6 over IPv4 when resolving server hostnames, falling back to IPv4 when no IPv6 address is reachable. | false   | No |
