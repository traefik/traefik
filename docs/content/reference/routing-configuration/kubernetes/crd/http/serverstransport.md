...
| `serverstransport.`<br />`cipherSuites` | Defines the cipher suites to use when contacting backend servers. | [] | No |
| `serverstransport.`<br />`minVersion` | Defines the minimum TLS version to use when contacting backend servers. | "" | No |
| `serverstransport.`<br />`maxVersion` | Defines the maximum TLS version to use when contacting backend servers. | "" | No |
