...
| <a id="opt-serverstransport-peerCertSubjectAltNames" href="#opt-serverstransport-peerCertSubjectAltNames" title="#opt-serverstransport-peerCertSubjectAltNames">`serverstransport.`<br />`peerCertSubjectAltNames`</a> | Defines the SANs (Subject Alternative Names) used to match against SANs during the peer certificate verification. | []      | No |
| <a id="opt-serverstransport-peerCertSubjectAltNames-type" href="#opt-serverstransport-peerCertSubjectAltNames-type" title="#opt-serverstransport-peerCertSubjectAltNames-type">`serverstransport.`<br />`peerCertSubjectAltNames[].type`</a> | Defines the SAN type (`URI` or `DNSName`) to match against the peer certificate's Subject Alternative Names.                                                                    | ""      | No       |
| <a id="opt-serverstransport-peerCertSubjectAltNames-value" href="#opt-serverstransport-peerCertSubjectAltNames-value" title="#opt-serverstransport-peerCertSubjectAltNames-value">`serverstransport.`<br />`peerCertSubjectAltNames[].value`</a> | Defines the SAN value to match against the peer certificate's Subject Alternative Names.                  | ""      | No       |
