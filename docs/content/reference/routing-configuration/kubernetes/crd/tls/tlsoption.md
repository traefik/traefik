...
!!! important "TLSOption in Kubernetes"
    ...
    When [`safeNaming`](../../../../install-configuration/providers/kubernetes/kubernetes-crd.md#safenaming) is enabled, the value becomes `<resource-namespace>_<resource-name>@kubernetescrd`, using the same `_` separator as the other names generated by the provider.
