...
!!! warning "Referencing resources in annotations"
    ...
    When [`safeNaming`](../../install-configuration/providers/kubernetes/kubernetes-crd.md#safenaming) is enabled,
    a namespaced `@kubernetescrd` reference must be of form `namespace_name@kubernetescrd`
    instead of `namespace-name@kubernetescrd`, using the same `_` separator as the other names generated by the provider.
