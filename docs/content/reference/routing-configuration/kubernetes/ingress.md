...
| <a id="opt-traefik-ingress-kubernetes-iorouter-respondingtimeouts-roundtrip" href="#opt-traefik-ingress-kubernetes-iorouter-respondingtimeouts-roundtrip" title="#opt-traefik-ingress-kubernetes-iorouter-respondingtimeouts-roundtrip">`traefik.ingress.kubernetes.io/router.respondingtimeouts.roundtrip`</a> | Defines the maximum duration for the whole client transaction on the router.<br/>`0` (or unset) means no timeout.<br/>See [responding timeouts](../http/routing/router.md#responding-timeouts) for more information. | `10s` |
