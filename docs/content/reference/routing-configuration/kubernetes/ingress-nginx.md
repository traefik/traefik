...
| <a id="opt-nginx-ingress-kubernetes-ioproxy-next-upstream-2" href="#opt-nginx-ingress-kubernetes-ioproxy-next-upstream-2" title="#opt-nginx-ingress-kubernetes-ioproxy-next-upstream-2">`nginx.ingress.kubernetes.io/proxy-next-upstream`</a> |                                                      |
| <a id="opt-nginx-ingress-kubernetes-ioproxy-next-upstream-timeout-2" href="#opt-nginx-ingress-kubernetes-ioproxy-next-upstream-timeout-2" title="#opt-nginx-ingress-kubernetes-ioproxy-next-upstream-timeout-2">`nginx.ingress.kubernetes.io/proxy-next-upstream-timeout`</a> |                                                      |
| <a id="opt-nginx-ingress-kubernetes-ioproxy-next-upstream-tries-2" href="#opt-nginx-ingress-kubernetes-ioproxy-next-upstream-tries-2" title="#opt-nginx-ingress-kubernetes-ioproxy-next-upstream-tries-2">`nginx.ingress.kubernetes.io/proxy-next-upstream-tries`</a> |                                                      |
