...
| <a id="opt-nginx-ingress-kubernetes-ioupstream-keepalive-timeout" href="#opt-nginx-ingress-kubernetes-ioupstream-keepalive-timeout" title="#opt-nginx-ingress-kubernetes-ioupstream-keepalive-timeout">`nginx.ingress.kubernetes.io/upstream-keepalive-timeout`</a> | Timeout can be defined globally at the provider level using the [`upstreamKeepaliveTimeout` option](../../../install-configuration/providers/kubernetes/kubernetes-ingress-nginx/#opt-providers-kubernetesIngressNGINX-upstreamKeepaliveTimeout). |
