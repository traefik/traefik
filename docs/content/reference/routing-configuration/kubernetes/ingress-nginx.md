...
| <a id="opt-nginx-ingress-kubernetes-iolimit-whitelist" href="#opt-nginx-ingress-kubernetes-iolimit-whitelist" title="#opt-nginx-ingress-kubernetes-iolimit-whitelist">`nginx.ingress.kubernetes.io/limit-whitelist`</a> | Comma-separated list of IPs and CIDR ranges excluded from rate limiting. Maps to the `excludedIPs` option of the generated RateLimit middleware. |
