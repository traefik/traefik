...
| <a id="opt-traefik-http-services-service-name-loadbalancer-healthcheck-fails" href="#opt-traefik-http-services-service-name-loadbalancer-healthcheck-fails" title="#opt-traefik-http-services-service-name-loadbalancer-healthcheck-fails">`traefik.http.services.<service_name>.loadbalancer.healthcheck.fails`</a> | See [health check](../http/load-balancing/service.md#health-check) for more information. | `3` |
| <a id="opt-traefik-http-services-service-name-loadbalancer-healthcheck-passes" href="#opt-traefik-http-services-service-name-loadbalancer-healthcheck-passes" title="#opt-traefik-http-services-service-name-loadbalancer-healthcheck-passes">`traefik.http.services.<service_name>.loadbalancer.healthcheck.passes`</a> | See [health check](../http/load-balancing/service.md#health-check) for more information. | `2` |
