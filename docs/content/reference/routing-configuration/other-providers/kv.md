...
| <a id="opt-traefikhttpservicesmyserviceloadbalancerhealthcheckfails" href="#opt-traefikhttpservicesmyserviceloadbalancerhealthcheckfails" title="#opt-traefikhttpservicesmyserviceloadbalancerhealthcheckfails">`traefik/http/services/myservice/loadbalancer/healthcheck/fails`</a> | See [health check](../http/load-balancing/service.md#health-check) for more information. | `3`  |
| <a id="opt-traefikhttpservicesmyserviceloadbalancerhealthcheckpasses" href="#opt-traefikhttpservicesmyserviceloadbalancerhealthcheckpasses" title="#opt-traefikhttpservicesmyserviceloadbalancerhealthcheckpasses">`traefik/http/services/myservice/loadbalancer/healthcheck/passes`</a> | See [health check](../http/load-balancing/service.md#health-check) for more information. | `2`  |
