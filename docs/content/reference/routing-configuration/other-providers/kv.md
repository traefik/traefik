...
| <a id="opt-traefikhttpservicesservice-nameloadbalancerhealthcheckfails" href="#opt-traefikhttpservicesservice-nameloadbalancerhealthcheckfails" title="#opt-traefikhttpservicesservice-nameloadbalancerhealthcheckfails">`traefik/http/services/<service_name>/loadbalancer/healthcheck/fails`</a> | See [health check](../http/load-balancing/service.md#health-check) for more information. | `3`  |
| <a id="opt-traefikhttpservicesservice-nameloadbalancerhealthcheckpasses" href="#opt-traefikhttpservicesservice-nameloadbalancerhealthcheckpasses" title="#opt-traefikhttpservicesservice-nameloadbalancerhealthcheckpasses">`traefik/http/services/<service_name>/loadbalancer/healthcheck/passes`</a> | See [health check](../http/load-balancing/service.md#health-check) for more information. | `2`  |
