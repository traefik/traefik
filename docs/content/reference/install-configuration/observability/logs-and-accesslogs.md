...
| <a id="opt-log-otlp-serviceNamespace" href="#opt-log-otlp-serviceNamespace" title="#opt-log-otlp-serviceNamespace">`log.otlp.serviceNamespace`</a> | Defines the service namespace resource attribute.                                                                                   |                                  | No       |
...
| <a id="opt-accesslog-otlp-serviceNamespace" href="#opt-accesslog-otlp-serviceNamespace" title="#opt-accesslog-otlp-serviceNamespace">`accesslog.otlp.serviceNamespace`</a> | Defines the service namespace resource attribute.                                                                                 |                                  | No       |
