...
!!! important "Kubernetes Namespace vs Traefik Namespace"
    ...
    When [`safeNaming`](./kubernetes/kubernetes-crd.md#safenaming) is enabled, the value becomes `<middleware-namespace>_<middleware-name>@kubernetescrd`, using the same `_` separator as the other names generated by the provider.
