...
| <a id="opt-providers-consulCatalog-allowEmptyServices" href="#opt-providers-consulCatalog-allowEmptyServices" title="#opt-providers-consulCatalog-allowEmptyServices">`providers.consulCatalog.allowEmptyServices`</a> | Instructs the provider to create services regardless of the health status reported by Consul. When enabled, `strictChecks` is ignored. | false | No |
