...
| <a id="opt-providers-kubernetesIngress-ingressEndpoint-ip" href="#opt-providers-kubernetesIngress-ingressEndpoint-ip" title="#opt-providers-kubernetesIngress-ingressEndpoint-ip">`providers.kubernetesIngress.`<br />`ingressEndpoint.ip`</a> | The IP address or comma-separated list of IP addresses copied to the Ingress `status.loadBalancer.ingress` field. IPv4 and IPv6 addresses can be combined.                                                                                                                                                                                                                                                                                                             | ""      | No       |
