...
| <a id="opt-providers-kubernetesIngressNGINX-httpsentrypoints" href="#opt-providers-kubernetesIngressNGINX-httpsntrypoints" title="#opt-providers-kubernetesIngressNGINX-httpsentrypoints">`providers.`<br/>`kubernetesIngressNGINX.`<br/>`httpsentrypoints`</a>                                                  | EntryPoint(s) (separated by comma) used for HTTPS requests.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ""     | No       |
