...
--providers.kubernetesingressnginx.ipallowlistdepth=2
...
| <a id="opt-providers-kubernetesIngressNGINX-ipAllowListDepth" href="#opt-providers-kubernetesIngressNGINX-ipAllowListDepth" title="#opt-providers-kubernetesIngressNGINX-ipAllowListDepth">`providers.`<br/>`kubernetesIngressNGINX.`<br/>`ipAllowListDepth`</a> | Defines the IP strategy depth applied to generated IPAllowList middlewares from `allowlist-source-range` and `whitelist-source-range` annotations. 0 disables this global override.                                                                                                                                                                                                                                                                                                                                                                               | 0       | No       |
