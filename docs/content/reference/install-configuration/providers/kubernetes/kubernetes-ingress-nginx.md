...
--providers.kubernetesingressnginx.upstreamkeepaliveconnections=320
...
| <a id="opt-providers-kubernetesIngressNGINX-upstreamKeepaliveConnections" href="#opt-providers-kubernetesIngressNGINX-upstreamKeepaliveConnections" title="#opt-providers-kubernetesIngressNGINX-upstreamKeepaliveConnections">`providers.`<br/>`kubernetesIngressNGINX.`<br/>`upstreamKeepaliveConnections`</a> | Defines the maximum number of idle keep-alive connections to upstream servers. 0 disables keep-alive connections.                                                                                                                                                                                                                                                                                                                                                                                                                     | 320             | No       |
