...
| <a id="opt-http-decodePathSlashes" href="#opt-http-decodePathSlashes" title="#opt-http-decodePathSlashes">`http.decodePathSlashes`</a> | Enable path slashes decoding. <br /> Use this option to remove encoded slashes (%2F, %2f, %5C, and %5c) from the request path. <br /> When using this option, the encoded slashes characters will be transmitted decoded to the backend.<br /> More information [here](#decodepathslashes).                                                                                                                                                                                                                                                                                                                                                                                         | false                   | No       |
...
The decoding of encoded slashes in the request path occurs before the path sanitization step (see [SanitizePath](#sanitizepath)).

Behavior examples:

| DecodePathSlashes                                                      | Request Path         | Resulting Request Path |
|------------------------------------------------------------------------|----------------------|------------------------|
| <a id="opt-false-3" href="#opt-false-3" title="#opt-false-3">false</a> | /segmentA%2FsegmentB | /segmentA%2FsegmentB   |
| <a id="opt-true-3" href="#opt-true-3" title="#opt-true-3">true</a> | /segmentA%2FsegmentB | /segmentA/segmentB     |
| <a id="opt-false-4" href="#opt-false-4" title="#opt-false-4">false</a> | /segmentA%5CsegmentB | /segmentA%5CsegmentB   |
| <a id="opt-true-4" href="#opt-true-4" title="#opt-true-4">true</a> | /segmentA%5CsegmentB | /segmentA\segmentB     |
...
| <a id="opt-false-7" href="#opt-false-7" title="#opt-false-7">false</a> | /foo/bar//      | /foo/bar//             |
| <a id="opt-true-7" href="#opt-true-7" title="#opt-true-7">true</a> | /foo/bar//      | /foo/bar/              |
| <a id="opt-false-8" href="#opt-false-8" title="#opt-false-8">false</a> | /./foo/../bar// | /./foo/../bar//        |
| <a id="opt-true-8" href="#opt-true-8" title="#opt-true-8">true</a> | /./foo/../bar// | /bar/                  |
