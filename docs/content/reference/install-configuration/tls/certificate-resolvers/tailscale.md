...
!!! info "Referencing a certificate resolver"
    ...
    Each router or entrypoint that is meant to use the resolver must explicitly [reference](../../../../reference/routing-configuration/http/routing/router.md#certresolver) it.
