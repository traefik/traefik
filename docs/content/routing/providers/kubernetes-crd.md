...
| [10] | `tls.secretName`           | Defines the name of the [secret](https://kubernetes.io/docs/concepts/configuration/secret/) (in the `IngressRoute` namespace) where Traefik should retrive certificate from|
