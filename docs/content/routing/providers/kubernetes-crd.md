...
| [12] | `startTLS`                     | Defines the [StartTLS protocol](../services/index.md#starttls-protocol) configuration                                                                                                                                                                                                                                                                                                |
| [13] | `proxyProtocol`                | Defines the [PROXY protocol](../services/index.md#proxy-protocol) configuration                                                                                                                                                                                                                                                                                                      |
| [14] | `version`                      | Defines the [PROXY protocol](../services/index.md#proxy-protocol) version                                                                                                                                                                                                                                                                                                            |
