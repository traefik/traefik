...
!!! info "safeNaming"
    ...
    When [`safeNaming`](../../providers/kubernetes-crd.md#safenaming) is enabled, the flattened form becomes
    `namespace_name@kubernetescrd`, using the same `_` separator as the other names generated by the provider.
