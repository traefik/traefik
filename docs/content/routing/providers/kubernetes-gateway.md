...
The Kubernetes Gateway API provider supports version [v1.5.0](https://github.com/kubernetes-sigs/gateway-api/releases/tag/v1.5.0) of the specification.
...
For more details, check out the conformance [report](https://github.com/kubernetes-sigs/gateway-api/tree/main/conformance/reports/v1.5.0/traefik-traefik).
