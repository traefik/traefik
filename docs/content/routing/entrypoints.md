...
The address defines the port, and optionally the hostname, on which to listen
...
If both TCP and UDP are wanted for the same port, two entryPoints definitions
are needed, such as in the example below.
