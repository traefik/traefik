...
Traefik Proxy hosts an official Grafana dashboard for both [on-premise](https://grafana.com/grafana/dashboards/17346) and [Kubernetes](https://grafana.com/grafana/dashboards/17347) deployments.
