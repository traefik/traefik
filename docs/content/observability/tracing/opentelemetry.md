...
```bash tab="CLI"
--tracing.otlp.headers.foo=bar --tracing.otlp.headers.baz=buz
```
...
[tracing]
  [tracing.otlp]
    [tracing.otlp.globalAttributes]
      attr1 = "foo"
      attr2 = "bar"
```

```bash tab="CLI"
--tracing.otlp.globalAttributes.attr1=foo
--tracing.otlp.globalAttributes.attr2=bar
```
