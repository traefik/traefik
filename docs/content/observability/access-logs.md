...
??? info "Available Fields"
    ...
    | `TLSKeyExchange`        | The key exchange mechanism used in the TLS handshake (e.g. `X25519`, `CurveP256`). For TLS 1.3 this is always set; for TLS 1.2 RSA key exchange it is absent.       |
