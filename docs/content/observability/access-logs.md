...
??? info "Available Fields"
    ...
    | `RequestPath`           | The HTTP request URI, not including the scheme, host or port. During filtering this does not contain the query, but even if RequestPath is dropped, RequestQuery will be logged in this field if it is kept.                                                                                                       |
    | `RequestQuery`           | The query portion of the HTTP request URI. While this field is exposed for filtering, when kept it is combined back into the RequestPath in the resulting log..                                                                                                       |
