...
- `OriginStatus` is the outcome of proxying the request to a backend. It is either the status returned by that backend, or, when the backend could not be reached or did not answer properly (`502`, `504`, ...).
