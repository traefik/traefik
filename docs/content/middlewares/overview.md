...
| [ReplacePathQueryRegex](replacepathqueryregex.md) | Change the path and the query of the request      | Path Modifier               |
| [ReplacePathRegex](replacepathregex.md)           | Change the path of the request                    | Path Modifier               |
| [ReplaceQueryRegex](replacequeryregex.md)         | Change the query of the request                   | Path Modifier               |
