...
!!! info
    ...
    * The response is not already compressed, i.e. the `Content-Encoding` response header is not already set.
    ...
    If Content-Type header is not defined, or empty, the compress middleware will proceed to a content type [detection](https://mimesniff.spec.whatwg.org/). 
    It will also set the `Content-Type` header with the detected MIME type.
