...
When [`safeNaming`](../../reference/install-configuration/providers/kubernetes/kubernetes-crd.md#safenaming) is enabled, the value becomes `<namespace>_<middleware-name>@kubernetescrd`, using the same `_` separator as the other names generated by the provider.
