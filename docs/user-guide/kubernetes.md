...
Now lets check if our DaemonSet was successfully deployed:
...
> You could also check the DaemonSet with the Kubernetes dashboard, run
...
Instead of installing Træfik via a DaemonSet object, you can also use the Træfik Helm chart.
