...
| xargs -0 -r -P "${NUMBER_OF_CPUS}" -I '{}' \
  ...
  --url-ignore "/localhost:/,/127.0.0.1:/,/fonts.gstatic.com/,/.minikube/,/github.com\/containous\/traefik\/*edit*/,/github.com\/containous\/traefik\/$/,/\.\.\/#/,/docs.traefik.io\/benchmark/,/\/img/" \
  '{}'
