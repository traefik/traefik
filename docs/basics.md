...
| `LocalIP: 2001:db8::1, 192.0.2.1`                          | Match listening IP address of local socket that accepted request. It accepts a sequence of literal IP addresses.                                                                                                                                                                        |
| `LocalAddr: [2001:db8::1]:80, 192.0.2.1:81`                | Match listening IP address and port of local socket that accepted request. It accepts a sequence of literal IP:port pairs.                                                                                                                                                              |
