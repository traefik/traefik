...
**Bug fixes:**
- **[webui]** fix: clean X-Forwarded-Prefix header for the dashboard. ([#7108](https://github.com/traefik/traefik/pull/7108) by [ldez](https://github.com/ldez))

**Documentation:**
- **[k8s,k8s/ingress]** Change apiVersion to apps/v1 in examples/k8s/cheese-deployments.yaml ([#7090](https://github.com/traefik/traefik/pull/7090) by [claflico](https://github.com/claflico))

## [v1.7.25](https://github.com/traefik/traefik/tree/v1.7.25) (2020-07-15)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.24...v1.7.25)

**Bug fixes:**
- **[middleware]** Fix ipv6 handling in redirect middleware ([#6901](https://github.com/traefik/traefik/pull/6901) by [rtribotte](https://github.com/rtribotte))
- **[provider]** Backport &#34;Same Configuration Check&#34; from master ([#6631](https://github.com/traefik/traefik/pull/6631) by [rkojedzinszky](https://github.com/rkojedzinszky))

**Documentation:**
- **[k8s]** Add ingress setup for minikube in docs ([#6552](https://github.com/traefik/traefik/pull/6552) by [kobayashi](https://github.com/kobayashi))
- Doc improvement on entrypoints whitelist for v1.7 ([#6571](https://github.com/traefik/traefik/pull/6571) by [ddtmachado](https://github.com/ddtmachado))

## [v1.7.24](https://github.com/traefik/traefik/tree/v1.7.24) (2020-03-25)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.23...v1.7.24)

**Bug fixes:**
- **[k8s/ingress]** fix: stickiness annotations support. ([#6576](https://github.com/traefik/traefik/pull/6576) by [ldez](https://github.com/ldez))

## [v1.7.23](https://github.com/traefik/traefik/tree/v1.7.23) (2020-03-23)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.22...v1.7.23)

**Bug fixes:**
- **[consul,consulcatalog,docker,ecs,k8s,marathon,mesos,rancher,sticky-session]** Fix sameSite ([#6537](https://github.com/traefik/traefik/pull/6537) by [ldez](https://github.com/ldez))
- **[server]** Force http/1.1 for upgrade ([#6553](https://github.com/traefik/traefik/pull/6553) by [juliens](https://github.com/juliens))
- **[tls]** fix: max TLS version. ([#6531](https://github.com/traefik/traefik/pull/6531) by [ldez](https://github.com/ldez))

## [v1.7.22](https://github.com/traefik/traefik/tree/v1.7.22) (2020-03-09)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.21...v1.7.22)

**Bug fixes:**
- **[provider]** Skip redirection with invalid regex syntax. ([#6446](https://github.com/traefik/traefik/pull/6446) by [ldez](https://github.com/ldez))
- **[server]** Clear closed hijacked h2c connections ([#6357](https://github.com/traefik/traefik/pull/6357) by [omerkay](https://github.com/omerkay))

**Documentation:**
- **[acme]** fix: manual provider code name. ([#6456](https://github.com/traefik/traefik/pull/6456) by [ldez](https://github.com/ldez))
- **[docker]** Fix typo in user guide. ([#6386](https://github.com/traefik/traefik/pull/6386) by [ldez](https://github.com/ldez))
- **[k8s]** Complete TLS example for Kubernetes Ingress in user guide ([#6457](https://github.com/traefik/traefik/pull/6457) by [rtribotte](https://github.com/rtribotte))
- **[k8s]** Updated rbac and Daemonset example bloc ([#6375](https://github.com/traefik/traefik/pull/6375) by [bjthomas1](https://github.com/bjthomas1))

## [v1.7.21](https://github.com/traefik/traefik/tree/v1.7.21) (2020-02-20)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.20...v1.7.21)

**Bug fixes:**
- **[acme]** Fix dnspod update. ([#6240](https://github.com/traefik/traefik/pull/6240) by [iineva](https://github.com/iineva))
- **[acme]** Fix finding proper provided certificate when ACME is enabled ([#5873](https://github.com/traefik/traefik/pull/5873) by [yazd](https://github.com/yazd))
- **[authentication,middleware]** don&#39;t create http client in each request in forward auth ([#6273](https://github.com/traefik/traefik/pull/6273) by [juliens](https://github.com/juliens))
- **[ecs]** fix: skip ECS container when information are missing instead of panic. ([#6071](https://github.com/traefik/traefik/pull/6071) by [ldez](https://github.com/ldez))
- **[k8s]** Add edge case for root path with rewrite-target ([#6005](https://github.com/traefik/traefik/pull/6005) by [dtomcej](https://github.com/dtomcej))

**Documentation:**
- **[k8s,k8s/ingress]** Update the k8s api version in the documentation ([#6162](https://github.com/traefik/traefik/pull/6162) by [jbdoumenjou](https://github.com/jbdoumenjou))
- **[middleware]** Improve rate-limiting doc ([#6277](https://github.com/traefik/traefik/pull/6277) by [mpl](https://github.com/mpl))
- **[provider]** Fix sample for ssl-header in docs ([#6337](https://github.com/traefik/traefik/pull/6337) by [pierresteiner](https://github.com/pierresteiner))

## [v1.7.20](https://github.com/traefik/traefik/tree/v1.7.20) (2019-12-09)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.19...v1.7.20)

**Bug fixes:**
- **[acme]** Truncate key for identification in log ([#5941](https://github.com/traefik/traefik/pull/5941) by [dtomcej](https://github.com/dtomcej))
- **[middleware]** fix: location header rewrite. ([#5857](https://github.com/traefik/traefik/pull/5857) by [ldez](https://github.com/ldez))

**Documentation:**
- Add a warning note regarding optional TLS mutual auth ([#5434](https://github.com/traefik/traefik/pull/5434) by [bradjones1](https://github.com/bradjones1))

## [v1.7.19](https://github.com/traefik/traefik/tree/v1.7.19) (2019-10-25)
[All Commits](https://github.com/traefik/traefik/compare/v1.7.18...v1.7.19)

**Bug fixes:**
- **[k8s,k8s/ingress]** Add functions to support precise float compute of weight ([#5663](https://github.com/traefik/traefik/pull/5663) by [rmrfself](https://github.com/rmrfself))
- **[middleware]** Fix Location response header http to https when SSL ([#5574](https://github.com/traefik/traefik/pull/5574) by [elielgoncalves](https://github.com/elielgoncalves))
- **[tls]** Allow Default Certificate to work on macOS 10.15 ([#5662](https://github.com/traefik/traefik/pull/5662) by [dtomcej](https://github.com/dtomcej))

**Documentation:**
- **[k8s]** Update DaemonSet apiVersion ([#5682](https://github.com/traefik/traefik/pull/5682) by [ialidzhikov](https://github.com/ialidzhikov))
...
- **[ecs]** Cache exising task definitions to avoid rate limiting ([#4177](https://github.com/traefik/traefik/pull/4177) by [hwhelan-CB](https://github.com/hwhelan-CB))
...
- **[acme]** Don&#39;t initalize ACME provider if storage is empty ([#3988](https://github.com/traefik/traefik/pull/3988) by [nmengin](https://github.com/nmengin))
...
- **[k8s]** Substitude hardcoded &#34;&lt;namespace&gt;/&lt;name&gt;&#34; with k8s ListerGetter ([#3470](https://github.com/traefik/traefik/pull/3470) by [yue9944882](https://github.com/yue9944882))
...
- **[acme]** Update github.com/go-acme/lego to 0.4.1 ([#2304](https://github.com/traefik/traefik/pull/2304) by [oldmantaiter](https://github.com/oldmantaiter))
